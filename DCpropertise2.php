	...
	<div class="row">
		<div class="col-md-4">
			<div class="card" style="width: 18rem;">
			  <img src="Pic/10.jpg" class="card-img-top" alt="...">
				<div class="card-body">
				    ...
				    <span style="color: green">$53000000</span>
				    <a href="pay.php" class="btn btn-primary">Buy</a>
			  	</div>
			</div>
		</div>
		<div class="col-md-4">
			<div class="card" style="width: 18rem;">
			  <img src="Pic/11.jpg" style="height: 200px;" class="card-img-top" alt="...">
			  	<div class="card-body">
		...
		<div class="col-md-4">
			<div class="card" style="width: 18rem;">
			  <img src="Pic/12.jpg" class="card-img-top" alt="...">
			  	<div class="card-body">
...
<div class="container" style="margin-top: 20px;">
	...
	<div class="row">
		<div class="col-md-4">
			<div class="card" style="width: 18rem;">
			  <img src="Pic/19.jpg" class="card-img-top" alt="...">
				<div class="card-body">
				    <h5 class="card-title">Duplex</h5>
				    <p class="card-text">The lake estate, is located along NTA road, very affordable houses with lake views.</p>
				    <span style="color: green">$53000000</span>
		...
		<div class="col-md-4">
			<div class="card" style="width: 18rem;">
			  <img src="Pic/20.jpg" style="height: 200px;" class="card-img-top" alt="...">
			  	<div class="card-body">
				    <h5 class="card-title">Castle</h5>
				    <p class="card-text">Peaceful and Calm estate with the best recrational park in Nigeria. It is located along Choba.</p>
				    <span style="color: green">$53000000</span>
